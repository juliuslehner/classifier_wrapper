...
//  */
// WrFFTErrors cufft_read_binary(const std::string& filename, void* input, int n, CufftPrecision precision);
...
//  */
// WrFFTErrors cufft_write_binary(const std::string& filepath, void* output, int n, CufftPrecision precision);

/**
 * @brief Execute a 1D cuFFT on the data already resident in GPU buffer.
 *
 ...
 */
WrFFTErrors cufft1d_plan(int n, Cufft1DContext** contextOut, CufftPrecision precision);
