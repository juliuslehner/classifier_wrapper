...
namespace example {
    ...
    std::pair<float, unsigned long long> measure_execution_ms(Kernel&& kernel, const unsigned int warm_up_runs, const unsigned int runs, cudaStream_t stream) {
        ...
        nvmlDevice_t device;
        unsigned long long GPUEnergy1, GPUEnergy2;
        //unsigned long long GPUEnergy1;
        ...
        unsigned long long GPUEnergy = (GPUEnergy2 - GPUEnergy1);
        return std::make_pair ((double)time, (double)GPUEnergy);
    }
